...
public:
	...
	// Orbit 3
	navigation::Seconds Toe() const { return _toe; }
	...
	navigation::GalileoTime getGST() const;
	navigation::GnssTime ToeEpoch() const { return navigation::toeEpoch(_GalWeek, _toe, _Epoch.Time()); }
